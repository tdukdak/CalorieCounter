...
// Initialize variables for entree
let entreeProtein = 0;
let entreeCarbs = 0;
let entreeFat = 0;
let entreeCalories = 0;

// Initialize variables for dessert
let dessertProtein = 0;
let dessertCarbs = 0;
let dessertFat = 0;
let dessertCalories = 0;

// Function to update the display for appetizer
function updateAppetizerDisplay() {
    ...
    // Calculate calories based on grams of protein, carbs, and fat
...
// Function to update the display for entree
...
// Function to update the display for dessert
